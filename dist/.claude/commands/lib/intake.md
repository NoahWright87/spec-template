...
2. Construct the raw file URL: replace the GitHub URL with a raw content URL, targeting the `main` branch, path: `.claude/commands/lib/intake.md`
   - For `https://github.com/OWNER/REPO`, the raw URL is `https://raw.githubusercontent.com/OWNER/REPO/main/.claude/commands/lib/intake.md`
