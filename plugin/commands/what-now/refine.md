---
description: "Clarify vague TODOs, add effort estimates, and open a PR with proposed spec updates"
argument-hint: "Optional: number of items to refine (default: 3)"
---
...
**In headless/agentic mode:** Default to **1** item instead of 3. Focus on refining one task really well rather than three tasks superficially.
...
After the PR is created, follow `/what-now:pr-review` — self-review the diff, leave explanatory comments, and respond to any Copilot or reviewer comments.
