---
description: "Generate spec files from an existing codebase; mark gaps with TODO placeholders"
argument-hint: "Optional scope hint (e.g., 'go deep in auth module', 'just map the top level')"
---
