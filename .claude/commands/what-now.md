...
|--------|------------------------|
| File ideas and GitHub Issues | `.claude/commands/intake.md` |
| Add detail to TODO items | `.claude/commands/refine.md` |
| Implement TODO items | `.claude/commands/knock-out-todos.md` |
| Backfill specs from existing code | `.claude/commands/spec-backfill.md` |
| Install or update the spec system | `.claude/commands/respec.md` |
